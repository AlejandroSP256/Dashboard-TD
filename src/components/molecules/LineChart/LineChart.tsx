    ...
    const chartData = {
        ...
        datasets: data.datasets.map((dataset, index) => ({
            ...
            borderColor: dataset.borderColor || 
                [colorPalette.primary, colorPalette.secondary, colorPalette.tertiary][index % 3],
            backgroundColor: dataset.backgroundColor ||
                (dataset.fill ?
                    `rgba(${parseInt(colorPalette.primary.slice(1, 3), 16)},
                    ${parseInt(colorPalette.primary.slice(3, 5), 16)},
                    ${parseInt(colorPalette.primary.slice(5, 7), 16), 0.1})`
                    : 'transparent'),
            borderWidth: 2,
            pointRadius: 3,
            pointHoverRadius: 6,
